...
export function CartSidebar() {
  ...
  return (
    <>
      ...
      />
      <div className="fixed inset-y-0 right-0 z-[101] flex w-full max-w-sm flex-col bg-card shadow-2xl transition-transform duration-300 ease-in-out border-l border-border/50">
        ...
        <div className="flex-1 overflow-y-auto p-5">
          {items.length === 0 ? (
            ...
            <div className="flex flex-col gap-4">
              {items.map((item) => (
                <div key={item.id} className="flex gap-4 items-center bg-background/50 p-3 rounded-xl border border-border/30">
